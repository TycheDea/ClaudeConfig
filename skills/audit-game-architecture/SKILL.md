...
description: Report-only audit of the ECS design (hecs), game loop, custom physics, and 3D math. Use when asked to review game/engine architecture, system ordering, physics correctness, or simulation structure.
---
