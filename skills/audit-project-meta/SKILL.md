...
description: Report-only audit of project infrastructure — docs/diagrams, verification/testing strategy, benchmarks-as-guardrails, scripts, and repo hygiene. Use when asked to review documentation, testing/verification coverage, or engineering process.
---
...
- `README.md`, `.claude/tasks/` (todo/plans), `content/source/**/GUIDE.md`
