...
description: Report-only audit of Rust language usage, workspace structure, and benchmarking/tooling. Use when asked to review Rust quality, crate organization, dependencies, or bench/profiling setup.
---
