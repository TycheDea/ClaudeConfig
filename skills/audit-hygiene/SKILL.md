---
name: audit-hygiene
description: Report-only audit of code hygiene — comment discipline, file/folder/module structure, oversized-file splits, function placement, dead code, and naming consistency. Use when asked to review code organization, comment policy, module boundaries, or where things live.
---
