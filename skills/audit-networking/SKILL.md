...
description: Report-only audit of QUIC transport (quinn/rustls), the protocol crate, state replication, tokio, and SQLite persistence. Use when asked to review networking, replication, protocol design, server architecture, or persistence.
---
