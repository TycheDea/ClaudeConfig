...
description: Report-only audit of the wgpu renderer, WGSL shaders, skeletal animation/skinning, glTF import, and egui. Use when asked to review rendering quality, GPU performance, animation correctness, or visual fidelity.
---
