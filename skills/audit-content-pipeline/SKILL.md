...
description: Report-only audit of the character/asset pipeline (Mixamo, VRoid, FBX→glTF, preprocessing scripts) and art-direction consistency. Use when asked to review the content pipeline, asset quality, or art tooling.
---
...
- `docs/visual-quality.md` and `.claude/tasks/aa-visual-upgrade-plan.md` — treat as stated intent; report where pipeline reality diverges
